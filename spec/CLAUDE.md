...
- **Stage:** specification complete and **all ten tasks Done** (2026-08-16). 708 tests, none
  skipped; seven fitness functions; ten evals; 40 browser cases; `bash ci/gate.sh` exits 0.
- **Done is not the same as decided.** Forty change entries are `proposed` and **none is
