...
- **Stage:** specification complete and **all ten tasks Done** (2026-08-16). 737 tests, none
  skipped; seven fitness functions; ten evals; 42 browser cases; `bash ci/gate.sh` exits 0.
- **Done is not the same as decided.** Forty-four change entries are `proposed` and **none is
